...
const (
	Query_Params_FullMethodName     = "/shahcoin.shahswap.v1.Query/Params"
	Query_Pool_FullMethodName       = "/shahcoin.shahswap.v1.Query/Pool"
	Query_Pools_FullMethodName      = "/shahcoin.shahswap.v1.Query/Pools"
	Query_SpotPrice_FullMethodName  = "/shahcoin.shahswap.v1.Query/SpotPrice"
	Query_LPPosition_FullMethodName = "/shahcoin.shahswap.v1.Query/LPPosition"
)
...
type QueryClient interface {
	...
	LPPosition(ctx context.Context, in *QueryLPPositionRequest, opts ...grpc.CallOption) (*QueryLPPositionResponse, error)
}
...
func (c *queryClient) LPPosition(ctx context.Context, in *QueryLPPositionRequest, opts ...grpc.CallOption) (*QueryLPPositionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QueryLPPositionResponse)
	err := c.cc.Invoke(ctx, Query_LPPosition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) LPPosition(context.Context, *QueryLPPositionRequest) (*QueryLPPositionResponse, error) {
...
func _Query_LPPosition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_LPPosition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Query_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "shahcoin.shahswap.v1.Query",
	...
	Metadata: "shahcoin/shahswap/v1/query.proto",
}
