...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shahcoin", "shahbridge", "v1", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Channels_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shahcoin", "shahbridge", "v1", "channels"}, "", runtime.AssumeColonVerbOpt(true)))
)
