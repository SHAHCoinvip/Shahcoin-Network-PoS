...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shahcoin", "shahswap", "v1", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Pool_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"shahcoin", "shahswap", "v1", "pools", "pool_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Pools_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shahcoin", "shahswap", "v1", "pools"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_SpotPrice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"shahcoin", "shahswap", "v1", "spot_price", "pool_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_LPPosition_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"shahcoin", "shahswap", "v1", "lp_position", "pool_id", "address"}, "", runtime.AssumeColonVerbOpt(true)))
)
